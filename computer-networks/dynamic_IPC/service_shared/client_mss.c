...
* Title		: client for shared service
********************************************************/
// Info : requests service from service coordinator 
// args : name of client to make fifos in server and client similarly 
...
{
	sleep(3);
	//write name in fmfifo to create fifos
	mkfifo("fmfifo",0666);
