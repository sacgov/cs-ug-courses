...
* Title		: client to nit_mss.c
********************************************************/
// Info : Implements an client which requests for a service
/*
services are s1 s2 s3 only
server returns a port of the service and client has to agin connect to it which provides it with service
//Basic structures :
/*
