...
* Title		: cyk algorithm to find if a string is derived by the language in its chomsky normal form or not!!
********************************************************/
// Info : 
// sample Input :
/*
A is start symbol
4 is no of production
a i string to be checed
copy paste below input 
