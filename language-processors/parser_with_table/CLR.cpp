        ...
        for(;it2!=T.end();it2++)
        {
            if(it2->lhs=='Z'&&it2->rhs==zod&&it2->lhd=='$')
            {
                    if(Table[i][SYM['$']].action>0)
                        {
                            cout<<"Error Not a CLR grammar ACCEPT";
                            return 0;
                        }
                ...
                if(a==it2->rhs.length()&&it2->lhs!='Z')
                {
                        ...
                        {
                            cout<<"Error Not a CLR gRammar Reduce";
                            return 0;
                        }
                ...
                j=State[gto[mp(T,it2->rhs[a])]];
                    if(prev!=it2->rhs&&Table[i][SYM[it2->rhs[a]]].action>0)
                        {
                            cout<<"Error Not a CLR gRammar SHIFT"<<it2->rhs;
                            print(T);
                            return 0;
                        }
                        else{
...
for(;it3!=IM.end();it3++)
{
if(Table[i][it3->first].action==1)
cout<<"\tS"<<Table[i][it3->first].state<<" ";

else if(Table[i][it3->first].action==2)
cout<<"\tR"<<Table[i][it3->first].state<<" ";
